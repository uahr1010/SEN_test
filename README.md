...
4. 루트의 `.pages.yml` 을 자동으로 읽어 **① 프로젝트 / ② 뉴스 / ③ 채용공고 / ④ 용어집 / ⑤ 번역 요청 / ⑥ 번역** 6개 편집 메뉴가 나타납니다
...
Pages CMS 왼쪽 메뉴가 곧 편집 대상입니다. **편집할 수 있는 것은 여섯 가지입니다.**
...
나오지 않습니다** — `content/projects.json` 자체가 "서울특별시 강남구" 같은
